...
这是一份面向新手的详细教程，教你如何安装和使用休假录入助手。

---

## 一、这个工具是干什么的？

休假录入助手是一个自动化脚本，可以帮你批量填写飞行门户的"非生产任务录入"表单。

比如你有一份 Excel 表格，里面有 50 个人的休假信息，正常情况下你需要手动填 50 次表单。用这个工具，你只需要把数据粘贴进去，它会自动帮你一条一条填写并提交。
